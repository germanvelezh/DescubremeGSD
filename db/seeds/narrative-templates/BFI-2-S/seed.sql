...
-- ===================== Cordialidad (AGR) =====================
  ('1.0', 'es-CO', 'dimension_band', 'AGR', 'BAJO', 'Tiendes a ser directo y a poner tus criterios sobre la mesa sin rodeos. A veces priorizás la franqueza antes que la armonía del grupo. Esto sugiere independencia de juicio. ¿En qué relaciones notás que esa franqueza ayuda y en cuáles podría matizarse?'),
  ('1.0', 'es-CO', 'dimension_band', 'AGR', 'MEDIO', 'Buscas un equilibrio entre cooperar y defender tu posición. Podés ceder cuando ves valor en el otro y mantenerte firme cuando algo te importa.'),
  ('1.0', 'es-CO', 'dimension_band', 'AGR', 'ALTO', 'Tiendes a confiar en las intenciones de los demás y a buscar el entendimiento antes que el conflicto. Esto sugiere una orientación cooperativa. ¿Cómo cuidás que esa apertura no te exponga en exceso?'),
-- ===================== Responsabilidad (CON) =====================
  ...
  ('1.0', 'es-CO', 'dimension_band', 'CON', 'MEDIO', 'Combinas planificación y adaptabilidad. Cumplís con lo importante sin volverte rígido.'),
  ('1.0', 'es-CO', 'dimension_band', 'CON', 'ALTO', 'Tiendes a planificar, cumplir plazos y mantener orden en tus tareas. Esto sugiere autodisciplina. ¿Cómo equilibrás esa exigencia con el descanso?'),
-- ===================== Sensibilidad emocional (NEG) — D-D.4 reframe =====================
  ('1.0', 'es-CO', 'dimension_band', 'NEG', 'BAJO', 'Tiendes a mantenerte estable frente a presiones y a recuperar tu equilibrio rápido tras un contratiempo. Esto sugiere alta tolerancia al estrés cotidiano. ¿Cómo notás cuándo sí necesitás parar?'),
  ('1.0', 'es-CO', 'dimension_band', 'NEG', 'MEDIO', 'Tu estado de ánimo se mueve con los eventos, dentro de un rango manejable. Sabés identificar qué te afecta y buscar apoyo cuando hace falta.'),
  ('1.0', 'es-CO', 'dimension_band', 'NEG', 'ALTO', 'Tiendes a percibir con intensidad las tensiones del día a día y a tomarte tiempo para procesar lo que sentís. Esto sugiere alta sensibilidad emocional. Conversar con personas de confianza o con un profesional puede ser de ayuda.'),
-- ===================== Apertura mental (OPN) =====================
  ('1.0', 'es-CO', 'dimension_band', 'OPN', 'BAJO', 'Preferís lo conocido y lo práctico antes que lo experimental. Esto sugiere un estilo concreto. ¿Qué experiencia nueva te gustaría probar este año?'),
  ('1.0', 'es-CO', 'dimension_band', 'OPN', 'MEDIO', 'Combinas rutinas y curiosidad: explorás cuando algo te interesa de verdad.'),
  ('1.0', 'es-CO', 'dimension_band', 'OPN', 'ALTO', 'Disfrutas ideas nuevas, arte y pensamiento abstracto. Esto sugiere alta curiosidad. ¿En qué áreas querés profundizar tu exploración?');
